...
pub fn generate_pulse_treshold(value: f32, tresh: f32) -> f32 {
...
pub fn generate_pulse_wave(time: f32, base_frequency: f32, duty_cycle: f32, amp:f32) -> f32 {
    let period = 1.0 / base_frequency;
    let t = time % period;
...
pub fn generate_sawtooth_wave(time: f32, base_freq: f32, duty_cycle: f32, amp: f32) -> f32 {
    let period: f32 = 1.0 / base_freq;
    let t = time % period;
    if t < duty_cycle * period {
        0.0
